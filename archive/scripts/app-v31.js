...
console.log("Main script loading (Intelligent Workflow Build v31)...");
...
const HEALING_MESSAGES = [
    "世界はあなたの頑張りに気づかないかもしれない。でも、あなたが今日一日を耐え抜いたことを、この場所だけは知っています。",
    "空回りした時間も、報われなかった思いも。全てを抱えたまま、今はただ、目を閉じて深く呼吸してください。",
    "『何のために働いているんだろう』。ふとした瞬間にこぼれ落ちるその虚しさを、否定せずにそのまま、ここで預けてください。",
    "特別なことは何も起きなかったかもしれない。けれど、あなたが今日を無事に終えようとしている。その当たり前の奇跡に、感謝を。",
    "無理に笑う必要はありません。今のあなたの、ありのままの静かな疲れを、私たちは一番大切に思っています。",
    "言葉にできない心の重荷。それを少しだけ置いて、心穏やかなひとときを。あなたは、もう十分に頑張りました。",
    "何も残らないような一日だったと思っていませんか。でも、あなたが今ここにいて、こうして息をついている。それだけで、十分すぎるほど価値があります。",
    "虚しさを抱えたまま、それでも今日を終えようとするあなたに。無理に前を向かなくていい。ただ、今日を生き抜いた自分を、今は少しだけ許してあげてください。"
];
