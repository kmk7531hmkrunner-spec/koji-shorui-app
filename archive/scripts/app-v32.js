...
const HEALING_MESSAGES = [
    "会社は数字しか見ないかもしれない。でも、あなたが今日あの現場で費やした数時間は、間違いなく誰かの明日を守りました。お疲れ様。",
    "上司の『当たり前』という言葉に、傷つく必要はありません。あなたが今日、一歩一歩進んだその足跡を、私はここでしっかりと見ていました。",
    "『終わればいい』。そう吐き捨てたくなる日もある。けれど、あなたが削り出したその時間は、あなたの人生の尊い一部です。本当にお疲れ様。",
    "誰も褒めてくれなくても、あなたは今日、一つの仕事を成し遂げました。その事実は、何よりも重く、尊いものです。",
    "『誰も見ていない』。そう思う時こそ、この手紙を思い出してください。あなたの誠実な仕事は、このアプリを通して私に届いています。",
    "今日、あなたが費やした膨大な時間とエネルギー。それを『当然』の一言で片付けさせはしません。あなたは、本当によくやりました。",
    "周りと比べる必要はありません。あなたが今日、目の前の仕事と向き合ったその姿勢こそが、あなた自身の誇りです。",
    "ふぅ、と深く息を吐いて。今日はもう、自分を責めるのはおしまい。あなたは今日一日、立派にやり抜きました。"
];
