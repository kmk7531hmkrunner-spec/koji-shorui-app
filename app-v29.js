...
const HEALING_MESSAGES = [
    "指先の泥は落ちても、今日あなたが積み上げた確かな仕事は消えません。お疲れ様でした。",
    "誰も見るでもない書類の隅々に、あなたの誠実さが滲んでいます。その一歩一歩が、誰かの安全に繋がっています。",
    "『終わった』という一言の裏にある、現場の喧騒と孤独な作業。その両方を知るあなたを、このアプリだけは知っています。",
    "今日も一日、本当にお疲れ様でした。あなたの仕事が、誰かの当たり前の日常を守っています。",
    "ふぅ、と深く息を吐いてください。この書類の完成は、あなたが今日一日を全力で走り抜けた証です。",
    "夕闇の中で灯る明かりのように、あなたの地道な努力が、現場の明日を照らしています。",
    "誰もいない事務所で、あるいは車内で。あなたの孤独な闘いを、私たちは心から称えます。",
    "お疲れ様です。あなたの手から生み出されたこの書類は、ただの紙ではなく、信頼の記録です。"
];
