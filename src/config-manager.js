 ...
 * Default coordinates and widths in percentage (%) and font sizes.
 */
  ...
  "kanryo": {
    "fields": [
      ...
      },
      {
        "id": "orderNumber",
        "label": "注文番号",
        "x": 11.842857142857135,
        "y": 39.590226918730714,
        "fontSize": 9,
        "width": 23,
        "align": "center"
      },
  ...
  "marusan": {
    "fields": [
      ...
      },
      {
        "id": "startTime",
        "label": "開始時間",
        "x": 27.758482142857126,
        "y": 24.164780541687875,
        "fontSize": 8,
        "width": 10
      },
      {
      ...
      },
      {
        "id": "content",
        "label": "作業内容",
        "x": 22.197544642857142,
        "y": 27.051955252812952,
        "fontSize": 8,
        "width": 52,
        "align": "left"
      },
...
export async function savePdfConfigAll(configObj) {
  // Save all modified layouts to idb
  const customConfig = await get(CONFIG_KEY) || {};
